...
def load_data(data_dir):
    ...
    # File format is "Portable Pixmap format (ppm)"
    for directory in os.listdir(data_dir):
        ...
        for file in os.listdir(os.path.join(data_dir, directory)):
            ...
            # Normalize all input to between 0 and 1
            images.append(resized/255)

            # "Folder name" is label
...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # Flatten 2D array for processing
...
def base_model():
    ...
    Based on cs50ai's model to recognize handwriting data from the EMNIST dataset.
    """
    model = tf.keras.models.Sequential([
